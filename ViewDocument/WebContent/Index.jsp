...
<%@ include file="System/menu.jsp" %>
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎使用文件上传下载系统</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    <a href="${pageContext.request.contextPath }/System/ViewDocument?type=all"><i class="icon-font">&#xe001;</i>文件管理</a>
